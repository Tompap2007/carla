...
class BasicScenario(object):
    ...
    def __init__(self, name, ego_vehicles, config, world,
        ...
        """
        logging.debug("basic_scenarion::__init__")
        self.other_actors = []
        ...
        logging.debug("basic_scenarion::_init_() ends")
    ...
    def _initialize_environment(self, world):
        ...
        """
        logging.debug("basic_scenarion::_initialize_environment()")
        ...
        logging.debug("basic_scenarion::_initialize_environment() ends")
    ...
    def _initialize_actors(self, config):
        ...
        Override this method in child class to provide custom initialization.
        """
        logging.debug("basic_scenarion::_initialize_actors()")
        ...
        logging.debug("basic_scenarion::_initialize_actors() ends")
