            ...
            for scenario in tree.iter("scenario"):
                ...
                if single_scenario_only:
                    ...
                    if scenario_config_type != scenario_name:
                        continue
                logging.debug("Parsing Config file : %s", file_name)
                ...
                for ego_vehicle in scenario.iter("ego_vehicle"):
                    logging.debug("ego_vehicle read from %s %s %s %s %s %s",file_name, ego_vehicle.attrib.get('x',0), ego_vehicle.attrib.get('y',0), ego_vehicle.attrib.get('z',0), ego_vehicle.attrib.get('yaw',0), ego_vehicle.attrib.get('model',"vehicle.lincoln.mkz2017"))
                    ...
                    logging.debug("new_config.trigger_points %s", *new_config.trigger_points)
