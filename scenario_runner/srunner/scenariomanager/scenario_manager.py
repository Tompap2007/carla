...
class ScenarioManager(object):
    ...
    def run_scenario(self):
        ...
        """
        logging.debug("ScenarioManager: Running scenario {%s}", self.scenario_tree.name)
        ...
        while self._running:
            ...
            # ~ There is no point to watch if timestamp has value
            # ~ simply execute the _tick_scenario wneh timestamp
            # ~ get its new value.
        ...
        if self.scenario_tree.status == py_trees.common.Status.FAILURE:
            logging.debug("ScenarioManager: Terminated due to failure")
    ...
    def analyze_scenario(self, stdout, filename, junit):
        ...
        if self.scenario.test_criteria is None:
            logging.info("Nothing to analyze, this scenario has no criteria")
            return True
